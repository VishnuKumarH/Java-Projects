...
public class Contact {
	...
	public Contact(String name, String mobileNumber, String mailId, java.util.Date dob) {
		super();
		this.name = name;
		this.mobileNumber = mobileNumber;
		this.mailId = mailId;
	...
	public String toString() {
		return "Contact [name=" + name + ", mobileNumber=" + mobileNumber + ", mailId=" + mailId + ", Date=" + dob
				+ "]";
	}
